...
class Shortcode {
	...
	public function __construct(){
		$this->shortcode_classes = apply_filters('diress_shortcode_map',array(
			'post_list'=>'\WPPM\Shortcode\PostList'
		));
	}
	...
	public function render_shortcode( $attributes='', $content='', $code ){
		...
		/** @var \WPPM\Shortcode\ShortcodeInterface $shortcode */
		...
		if( ! in_array( 'WPPM\Shortcode\ShortcodeInterface', class_implements( $shortcode) ) ){
			$message = "The rendering class for your shortcode: $code, must implement the WPPM\\Shortcode\\ShortcodeInterface";
			_doing_it_wrong('\WPPM\Shortcode::render_shortcode',$message, '1.9.0' );
